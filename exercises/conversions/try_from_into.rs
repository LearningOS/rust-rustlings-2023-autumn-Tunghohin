...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        let (r, g, b) = tuple;
        let r = u8::try_from(r).or(Err(IntoColorError::IntConversion))?;
        let g = u8::try_from(g).or(Err(IntoColorError::IntConversion))?;
        let b = u8::try_from(b).or(Err(IntoColorError::IntConversion))?;
